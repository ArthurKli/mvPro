...
public class CodeResourceUtil
{
  ...
  public static String URL = "jdbc:mysql://localhost:3378/test?useUnicode=true&characterEncoding=UTF-8";
  ...
  public static String resource_main_package = "src/main/resources";
