...
public class CodeGenerateFactory
{
  ...
  public static void codeGenerate(String tableName, String codeName, String entityPackage, String controllerEntityPackage, String keyType)
  {
    ...
    String mybatisMapperPath = projectPath + CodeResourceUtil.resource_main_package + "\\";
    ...
    String controllerPath = "action\\" +cPath + className + "Controller.java";
...
//    CommonPageParser.WriterPage(context, "ServiceImplTemplate.ftl", pckPath, serviceImplPath);
    CommonPageParser.WriterPage(context, "MapperTemplate.xml", mybatisMapperPath, sqlMapperPath);
