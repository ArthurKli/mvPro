...
import com.admin.tools.MD5Util;
...
private TdMenuService tdMenuService;
	...
	public static boolean isValidateCodeLogin(String useruame, boolean isFail, boolean clean){
		Map<String, Integer> loginFailMap = (Map<String, Integer>)com.admin.cache.CacheUtils.get("loginFailMap");
		if (loginFailMap==null){
			loginFailMap = new HashMap();
			com.admin.cache.CacheUtils.put("loginFailMap", loginFailMap);
		}
